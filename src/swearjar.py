...
def update_status(status_text):
    os.system('cls')
    the_rows = [["Swear-Jar Counter","v1.9-3"],["Selected Device",selected_device],["Total Words", total_words],["Swears Per Word", swears_per_word],["Swear Count", swear_count],["Most Recent Text", most_recent_record],[" "," "],[" "," "],["Stats", status_text],["Press CTRL+C to Exit",""]]
    t = Texttable()
    t.add_rows(the_rows)
    print(t.draw())
